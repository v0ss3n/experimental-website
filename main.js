...
(function() {
  var container = document.getElementById("moulage-grid-container1"),
    inner = document.getElementById("moulage-grid1");
...
(function() {
  var container = document.getElementById("moulage-grid-container2"),
    inner = document.getElementById("moulage-grid2");
